...
user_name = check_markdown(data.first_name_)
  ...
  if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| You can't ban_ *mods,owners and bot admins*", 0, "md")
   else
  return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حظر المدراء او الادمنيه*", 0, "md")
         end
     end
...
user_name = check_markdown(data.first_name_)
  ...
  if not administration['gban_users'] then
    ...
    save_data(_config.moderation.data, administration)
     ...
     if data.id_ == our_id then
  if not lang then
 return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| You can't_ *globally ban* _other admins_", 0, "md")
  else
  return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حظر المدراء او الادمنيه*", 0, "md")
        end
     end
...
tdcli_function ({
  ...
  if not lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "_🌟| You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
...
channel_unblock(data.chat_id_, data.sender_user_id_)
  ...
  if cmd == "delall" then
   ...
   if not lang then
 return tdcli.sendMessage(data.chat_id_, "", 0, "_🌟| You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
...
tdcli.deleteMessagesFromUser(data.chat_id_, data.sender_user_id_, dl_cb, nil)
   if not lang then
 return tdcli.sendMessage(data.chat_id_, "", 0, "_🌟| All_ *messages* _of_ *[ "..data.sender_user_id_.." ]* _has been_ *deleted*", 0, "md")
      elseif lang then
...
channel_unblock(arg.chat_id, data.id_)
  ...
  if cmd == "silent" then
     if data.id_ == our_id then
  if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| You can't silent_ *mods,owners and bot admins*", 0, "md")
    else
  return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع كتم المدراء او الادمنيه*", 0, "md")
       end
     end
...
if not is_gbanned(data.id_) then
  ...
  if cmd == "kick" then
     if data.id_ == our_id then
  if not lang then
 return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع طرد المدراء او الادمنيه*", 0, "md")
   end
...
channel_unblock(arg.chat_id, data.id_)
  ...
  if cmd == "delall" then
   if is_mod1(arg.chat_id, data.id_) then
   if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حذف رسائل المدراء او الادمنيه*", 0, "md")
   end
  else
tdcli.deleteMessagesFromUser(arg.chat_id, data.id_, dl_cb, nil)
   if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "_🌟| All_ *messages* _of_ "..user_name.." *[ "..data.id_.." ]* _has been_ *deleted*", 0, "md")
      elseif lang then
...
channel_unblock(msg.to.id, matches[2])
 ...
 if (matches[1] == "delall" and is_mod(msg) and not Clang) or (matches[1] == "مسح الكل" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "_🌟| You can't delete messages mods,owners or bot admins_", 0, "md")
     elseif lang then
   return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حذف رسائل المدراء او الادمنيه*", 0, "md")
   end
     else
tdcli.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
    if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "_🌟| All_ *messages* _of_ *[ "..matches[2].." ]* _has been_ *deleted*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*🌟| رسائل العضو* \n*[ "..data.sender_user_id_.." ]* *تم مسحها 🗑*", 0, "md")
         end
      end
 ...
 if (matches[1] == "banall" and is_admin(msg) and not Clang) or (matches[1] == "حظر عام" and is_admin(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "_🌟| You can't globally ban other admins_", 0, "md")
else
    return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حظر المدراء او الادمنيه*", 0, "md")
        end
     end
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟| _ تم الغاء حظره العام ☑️_', 0, "md")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   ...
   if msg.to.type ~= 'pv' then
 if (matches[1] == "ban" and is_mod(msg) and not Clang) or (matches[1] == "حظر" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
 return tdcli.sendMessage(msg.to.id, "", 0, "_🌟| You can't ban mods,owners or bot admins_", 0, "md")
    else
    return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حظر المدراء او الادمنيه*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.to.id)
 ...
 if (matches[1] == "unban" and is_mod(msg) and not Clang) or (matches[1] == "الغاء العام" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "_🌟| You can't silent mods,leaders or bot admins_", 0, "md")
 else
   return tdcli.sendMessage(arg.chat_id, "", 0, "*🌟| لا تستطيع حظر المدراء او الادمنيه*", 0, "md")
        end
     end
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _User_ ['..user_name..'] \n🌟| _ID_ *['..data.id_..']*\n🌟| _added to silent users list ☑️_', 0, "md")
 ...
 if (matches[1] == "unsilent" and is_mod(msg) and not Clang) or (matches[1] == "الغاء الكتم" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ...
      username_ = matches[2]
		...
		if (matches[1] == "clean" and is_owner(msg) and not Clang) or (matches[1] == "مسح" and is_owner(msg) and Clang) then
			if (matches[2] == 'bans' and not Clang) or (matches[2] == 'قائمه الحظر' and Clang) then
     ...
     if not lang then
				return "_🌟| All_ *banned* _users has been unbanned_"
    else
				return "*🌟| تم الغاء الحظر عن جميع المستخدمين في هذه المجموعه*"
           end
			end
			if (matches[2] == 'silentlist' and not Clang) or (matches[2] == 'قائمه الكتم' and Clang) then
				if next(data[tostring(chat)]['is_silent_users']) == nil then
        if not lang then
					return "_🌟| No_ *silent* _users in this group_"
   else
       ...
       if not lang then
		...
		if (matches[1] == "clean" and is_sudo(msg) and not Clang) or (matches[1] == "مسح" and is_sudo(msg) and Clang) then
			if (matches[2] == 'gbans' and not Clang) or (matches[2] == 'قائمه العام' and Clang) then
 ...
 if (matches[1] == "gbanlist" and is_admin(msg) and not Clang) or (matches[1] == "قائمه العام" and is_admin(msg) and Clang) then
  return gbanned_list(msg)
 end
   if msg.to.type ~= 'pv' then
 if (matches[1] == "silentlist" and is_mod(msg) and not Clang) or (matches[1] == "قائمه الكتم" and is_mod(msg) and Clang) then
  return silent_users_list(chat)
 end
 if (matches[1] == "banlist" and is_mod(msg) and not Clang) or (matches[1] == "قائمه الحظر" and is_mod(msg) and Clang) then
